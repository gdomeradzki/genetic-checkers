...
TEST_F(MetricsCalculatorTests, SingleMetricCalcPawnsNumberEqual)
{
    ...
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber, 2}}, game, FigureColor::White), metricsHalfRange * 2);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber, 2}}, game, FigureColor::Black), metricsHalfRange * 2);
}
TEST_F(MetricsCalculatorTests, SingleMetricCalcPawnsNumberRatio1To12)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::White), 4);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::Black), 95);
}
TEST_F(MetricsCalculatorTests, SingleMetricCalcPawnsNumberRatio12To1)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::White), 95);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::Black), 4);
}
TEST_F(MetricsCalculatorTests, SingleMetricCalcPawnsNumberRatio2To3)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::White), 45);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::Black), 54);
}
TEST_F(MetricsCalculatorTests, SingleMetricCalcPawnsNumberRatio5To2)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::White), 58);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsNumber}}, game, FigureColor::Black), 41);
}
TEST_F(MetricsCalculatorTests, SingleMetricCalcKingsRatio3To3)
{
    ...
    board[2][0] = FigureState{FigureType::King, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsNumber}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsNumber}}, game, FigureColor::Black), 50);
}
...
TEST_F(MetricsCalculatorTests, SingleMetricSafePawnsRatio1To3)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::SafePawns}}, game, FigureColor::White), 40);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::SafePawns}}, game, FigureColor::Black), 60);
}
TEST_F(MetricsCalculatorTests, SingleMetricSafeKingRatio3To0)
{
    ...
    board[6][0] = FigureState{FigureType::King, FigureColor::White};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::SafeKings}}, game, FigureColor::White), 62);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::SafeKings}}, game, FigureColor::Black), 37);
}
...
TEST_F(MetricsCalculatorTests, SingleMetricCenterPawnsRatio2To2)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::CenterPawns}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::CenterPawns}}, game, FigureColor::Black), 50);
}
TEST_F(MetricsCalculatorTests, SingleMetricCenterKingRatio1To0)
{
    ...
    board[6][0] = FigureState{FigureType::King, FigureColor::White};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::CenterKings}}, game, FigureColor::White), 54);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::CenterKings}}, game, FigureColor::Black), 45);
}
TEST_F(MetricsCalculatorTests, SingleMetricMovablePawnsRatio1To2)
{
    ...
    board[2][2] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::MoveablePawns}}, game, FigureColor::White), 45);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::MoveablePawns}}, game, FigureColor::Black), 54);
}
TEST_F(MetricsCalculatorTests, SingleMetricMovableKingsRatio4To1)
{
    ...
    board[5][5] = FigureState{FigureType::King, FigureColor::White};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::MoveableKings}}, game, FigureColor::White), 62);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::MoveableKings}}, game, FigureColor::Black), 37);
}
TEST_F(MetricsCalculatorTests, SingleMetricAggregatedDistanceToPromotionLine1To1)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AggregatedDistanceToPromotionLine}}, game, FigureColor::White), 100);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AggregatedDistanceToPromotionLine}}, game, FigureColor::Black), 0);
}
TEST_F(MetricsCalculatorTests, SingleMetricAggregatedDistanceToPromotionLine6to3)
{
    ...
    board[7][5] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AggregatedDistanceToPromotionLine}}, game, FigureColor::White), 62);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AggregatedDistanceToPromotionLine}}, game, FigureColor::Black), 37);
}
TEST_F(MetricsCalculatorTests, SingleMetricUnoccupiedFields3To1)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(
        sut->evaluate({MetricFactor{Metric::NumberOfUnoccupiedFieldOnPromotionLine}}, game, FigureColor::White), 75);
    EXPECT_EQ(
        sut->evaluate({MetricFactor{Metric::NumberOfUnoccupiedFieldOnPromotionLine}}, game, FigureColor::Black), 25);
}
TEST_F(MetricsCalculatorTests, SingleMetricDefendingFigures2To3)
{
    ...
    board[7][5] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::DefenderFigures}}, game, FigureColor::White), 45);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::DefenderFigures}}, game, FigureColor::Black), 54);
}
TEST_F(MetricsCalculatorTests, SingleMetricAttackingFigures1To3)
{
    ...
    board[7][5] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AttackingFigures}}, game, FigureColor::White), 41);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::AttackingFigures}}, game, FigureColor::Black), 58);
}
TEST_F(MetricsCalculatorTests, SingleMetricPawnsOnDiagonal3To1)
{
    ...
    board[7][5] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsOnDiagonal}}, game, FigureColor::White), 64);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsOnDiagonal}}, game, FigureColor::Black), 35);
}
TEST_F(MetricsCalculatorTests, SingleMetricKingsOnDiagonal0To3)
{
    ...
    board[7][5] = FigureState{FigureType::Pawn, FigureColor::Black};
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsOnDiagonal}}, game, FigureColor::White), 31);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsOnDiagonal}}, game, FigureColor::Black), 68);
}
TEST_F(MetricsCalculatorTests, SingleMetricPawnsOnDoubleDiagonal5To1)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsOnDoubleDiagonal}}, game, FigureColor::White), 31);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::PawnsOnDoubleDiagonal}}, game, FigureColor::Black), 68);
}
TEST_F(MetricsCalculatorTests, SingleMetricKingsOnDoubleDiagonal5To1)
{
    ...
    GameState game{std::move(board)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsOnDoubleDiagonal}}, game, FigureColor::White), 33);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingsOnDoubleDiagonal}}, game, FigureColor::Black), 66);
}
TEST_F(MetricsCalculatorTests, SingleMetricTrianglePattern)
{
    ...
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Triangle}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Triangle}}, game, FigureColor::Black), 50);
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Triangle}}, game, FigureColor::White), 100);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Triangle}}, game, FigureColor::Black), 0);
...
TEST_F(MetricsCalculatorTests, SingleMetricOreoPattern)
{
    ...
    auto copyBoard = board;
    GameState game{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Oreo}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Oreo}}, game, FigureColor::Black), 50);
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Oreo}}, game, FigureColor::White), 100);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Oreo}}, game, FigureColor::Black), 0);
...
TEST_F(MetricsCalculatorTests, SingleMetricBridgePattern)
{
    ...
    auto copyBoard = board;
    GameState game{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Bridge}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Bridge}}, game, FigureColor::Black), 50);
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Bridge}}, game, FigureColor::White), 100);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Bridge}}, game, FigureColor::Black), 0);
...
TEST_F(MetricsCalculatorTests, SingleMetricPawnCornerPattern)
{
    ...
    auto copyBoard = board;
    GameState game{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Corner}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Corner}}, game, FigureColor::Black), 50);
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Corner}}, game, FigureColor::White), 100);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Corner}}, game, FigureColor::Black), 0);
...
TEST_F(MetricsCalculatorTests, SingleMetricKingCornerPattern)
{
    ...
    auto copyBoard = board;
    GameState game{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingCorner}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingCorner}}, game, FigureColor::Black), 50);
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingCorner}}, game, FigureColor::White), 0);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::KingCorner}}, game, FigureColor::Black), 100);
...
TEST_F(MetricsCalculatorTests, SingleMetricDogPattern)
{
    ...
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Dog}}, game, FigureColor::White), 50);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Dog}}, game, FigureColor::Black), 50);

    board[0][6] = FigureState{FigureType::Pawn, FigureColor::Black};
    copyBoard = board;
    game = GameState{std::move(copyBoard)};
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Dog}}, game, FigureColor::White), 0);
    EXPECT_EQ(sut->evaluate({MetricFactor{Metric::Dog}}, game, FigureColor::Black), 100);
